...
class DashVectorDocumentRetrieverTest {
    ...
    void retrievesContextsFromVectorMatches() {
        ...
        DocumentEntity highDocument = document(10L, "High Title", "full high");
        DocumentEntity lowDocument = document(20L, null, "full low");
        when(documentRepository.findAllById(anyIterable())).thenReturn(List.of(highDocument, lowDocument));
