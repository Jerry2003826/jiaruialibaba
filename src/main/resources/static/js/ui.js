...
window.AgentWorkbench = window.AgentWorkbench || {};
  ...
  function cacheElements() {
    const ids = [
      ...
      "undo-workflow", "repair-workflow", "save-definition", "run-workflow", "wf-more", "wf-menu", "new-workflow", "generate-workflow", "validate-workflow",
      ...
      "workflow-generator", "generator-close", "generator-prompt", "generator-preview", "generator-edit-current",
      "generator-apply",
      ...
      "settings-tavily-status", "settings-tavily-key", "save-tavily-key", "clear-tavily-key", "settings-tavily-hint",
      "http-credential-form", "http-credential-name", "http-credential-type", "http-credential-fields",
      "http-credential-token", "http-credential-header-name", "http-credential-value",
      "http-credential-username", "http-credential-password", "save-http-credential", "http-credential-list",
